...
export function createService({seed,visitsStore,sessionsStore,attemptsStore,adminUsername,adminPassword,now=Date.now}){
 if(!adminUsername||!adminPassword||adminPassword.length>=256)throw Error('ตั้งค่า ADMIN_USERNAME และ ADMIN_PASSWORD สำหรับ Netlify');
 const salt=randomBytes(16).toString('hex'),passwordHash=scryptSync(adminPassword,salt,64);
